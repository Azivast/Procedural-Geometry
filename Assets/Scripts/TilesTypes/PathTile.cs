...
public class PathTile : TileMesh
{
    ...
    {
        mesh.name = "Path";
        thisTileProperty = GridTileProperty.Solid;
    ...
    protected override void GenerateSidePiece(Vector3 translation, Quaternion rotation, Vector3 scale)
    {
        ...
        int g = builder.AddVertex(new Vector3(0.3f, 0, 0.15f), new Vector3(0, 1, 0), new Vector2(0, 1));
        ...
        int k = builder.AddVertex(new Vector3(0.3f, -0.5f, 0.55f), new Vector3(0, 1, 0), new Vector2(0, 1));
